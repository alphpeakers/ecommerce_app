              ...
              Row(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      CustomInkTap(
                        onPress: () => Get.toNamed(AppRoutes.favouriteScreen),
                      child: Text('Store Location', style: theme.textTheme.labelSmall)),
                      Row(
                        children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        shape: BoxShape.circle, color: AppTheme.white),
                    child:
                        Center(child: SvgPicture.asset(ImageConstants.myCard)),
                  ),
                ],
              ),
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) => Obx(() {
                    bool isSelect = tabBarController.currentPage.value == index;
